            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-2xl font-bold text-blue-500 mb-3">{project.title}</h3>
                  <p className="text-white mb-4">{project.description}</p>
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 bg-black/50 backdrop-blur-lg rounded-full text-sm text-blue-200"
                      >
                        {tech}
                      </span>
                    ))}
